...
// SOLO ESTA CONEXIÓN DEBE QUEDAR AQUÍ:
include 'r_db.php'; 
verificarPlanPlus(); // El portero de seguridad Plus

$mi_restaurant_id = (int)$_SESSION['restaurant_id'];

// ... (El resto de tu código de estadísticas hacia abajo)

// ... (El resto de tu código de análisis de 21 días se queda IGUAL)
...
// --- SALIDA SILENCIOSA PARA LA IA ---
// En lugar de imprimir, guardamos en variable
$datos_para_la_ia = json_encode($paquete_edubo, JSON_UNESCAPED_UNICODE);
?>