...
// Recibimos la información de la URL
...
if ($es_cliente) {
    include 'gestion_rapida/r_db.php';
...
<head>
    <meta charset="UTF-8">
    <title>Bargaiwe Fast - Finalizar Compra</title>
    <style>
        ...
        /* BOTONES DE NAVEGACIÓN ARREGLADOS */
        .nav-flotante { position: absolute; top: 20px; left: 30px; display: flex; flex-direction: column; gap: 10px; z-index: 100; }
        .btn-volver { color: #8b949e; text-decoration: none; font-weight: bold; padding: 8px 15px; border-radius: 8px; transition: 0.3s; display: flex; align-items: center; gap: 8px; border: 1px solid transparent; }
        .btn-volver:hover { color: white; background: rgba(255,255,255,0.05); border: 1px solid #30363d; transform: translateX(-5px); }
        ...
        /* COLORES FAST FOOD */
        .resumen h2 { margin-top: 0; font-size: 1.8rem; color: #FF5252; }
        ...
        /* TEMA ESTÁNDAR (Rojo Oscuro) */
        .checkout-container.tema-estandar { background: #161b22; border: 1px solid #30363d; box-shadow: 0 10px 40px rgba(0,0,0,0.5); }
        .tema-estandar .resumen { background: #8B0000; }

        /* TEMA PREMIUM (Borde Rojo Brillante) */
        .checkout-container.tema-premium { background: #0d1117; border: 2px solid #E53935; box-shadow: 0 0 30px rgba(229, 57, 53, 0.2); }
        .tema-premium .resumen { background: rgba(22, 27, 34, 0.8); border-right: 1px solid rgba(229, 57, 53, 0.3); }
        ...
        .grupo-form input { width: 100%; padding: 12px; border: 1px solid #30363d; border-radius: 8px; font-size: 1rem; box-sizing: border-box; background: #010409; color: white; outline-color: #FF5252; }
        
        /* BOTÓN PAGAR (Naranja/Rojo) */
        .btn-pagar { background: #E53935; color: white; border: none; padding: 15px; width: 100%; border-radius: 8px; font-size: 1.2rem; font-weight: 900; cursor: pointer; transition: 0.3s; margin-top: 10px; text-transform: uppercase; letter-spacing: 1px;}
        .btn-pagar:hover { background: #FF5252; transform: scale(1.02); box-shadow: 0 5px 15px rgba(229, 57, 53, 0.3);}
        ...
        .caja-futuro { background: rgba(229, 57, 53, 0.1); border: 1px solid #E53935; padding: 20px; border-radius: 10px; margin-bottom: 20px; text-align: center; }
        .caja-futuro strong { color: #FF5252; font-size: 1.2rem; }
    </style>
</head>
<body>

    <div class="nav-flotante">
        <a href="suscripciones_rapida.php" class="btn-volver">← Volver a los Planes</a>
    ...
    <div class="checkout-container <?php echo $clase_tema; ?>">
        <div class="resumen">
            ...
            <div class="item-resumen"><span>Plan Elegido:</span> <strong>Bargaiwe Fast <?php echo htmlspecialchars($plan); ?></strong></div>
            <div class="item-resumen"><span>Duración:</span> <strong><?php echo $meses; ?> Meses</strong></div>
            
            <?php if (!empty($beneficio)): ?>
            <div class="item-resumen" style="color: #FF5252; font-weight: 900; border-bottom: none;">
            ...
            <div style="margin-top: auto;">
                ...
                <div style="text-align: center; font-size: 1.2rem; color: #FF5252; font-weight: bold; margin-top: 5px;">
        ...
        <div class="formulario">
            ...
            <?php if (!$es_cliente): ?>
                ...
                <form action="pasarela_mp.php" method="POST">
                    ...
                    <input type="hidden" name="tipo_local" value="rapida">
                    <input type="hidden" name="es_renovacion" value="0">
                    
                    <div class="grupo-form">
                        <label>Nombre de tu Food Truck / Local</label>
                        <input type="text" name="nombre_restaurante" placeholder="Ej: Burgers Don Lukas" required autofocus>
                    </div>
                    <div class="grupo-form">
                        <label>Correo Electrónico (Tu usuario)</label>
                        <input type="email" name="email_cliente" placeholder="admin@tulocal.com" required>
                    </div>
                    <div class="grupo-form">
            ...
            <?php else: ?>
                ...
                <p style="color: #c9d1d9; font-size: 1.1rem; margin-bottom: 30px;">Elegiste agregar el plan <strong>Bargaiwe Fast <?php echo htmlspecialchars($plan); ?></strong> a tu cuenta existente.</p>
